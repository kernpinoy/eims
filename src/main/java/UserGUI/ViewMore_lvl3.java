 ...
 */
public class ViewMore_lvl3 extends javax.swing.JFrame {
    private int emp_id;
    private static dashboard_lvl3 view = null;
    
    /**
     * Creates new form ViewMore_Admin
     */
    public ViewMore_lvl3() {
        setVisible(true);
        initComponents();
    }
    
    public ViewMore_lvl3(int emp_id) {
        setVisible(true);
        initComponents();
        this.emp_id = emp_id;
    }
    
    public ViewMore_lvl3(dashboard_lvl3 newView) {
        setVisible(true);
        initComponents();
        view = newView;
    }
    ...
    private void initComponents() {
        ...
        pi_firstName.setEditable(false);
        pi_firstName.setBackground(new java.awt.Color(241, 241, 241));

        pi_midName.setEditable(false);
        ...
        pi_bloodType.setEditable(false);
        ...
        pi_citizenship.setEditable(false);
        ...
        elem_schlname.setEditable(false);
        ...
        elem_schladd.setEditable(false);
        elem_schladd.setBackground(new java.awt.Color(241, 241, 241));

        elem_yeargrad.setEditable(false);
        ...
        sec_schlname.setEditable(false);
        ...
        sec_schladd.setEditable(false);
        sec_schladd.setBackground(new java.awt.Color(241, 241, 241));

        sec_yearReal.setEditable(false);
        ...
        ter_schlname.setEditable(false);
        ...
        ter_schladd.setEditable(false);
        ter_schladd.setBackground(new java.awt.Color(241, 241, 241));

        ter_degree.setEditable(false);
        ...
        ter_yeargrad.setEditable(false);
        ...
        child_surname.setEditable(false);
        ...
        child_firstname.setEditable(false);
        ...
        child_midname.setEditable(false);
        ...
        father_surname.setEditable(false);
        ...
        father_fname.setEditable(false);
        ...
        father_mname.setEditable(false);
        ...
        mother_surname.setEditable(false);
        ...
        mother_firstname.setEditable(false);
        ...
        mother_middlename.setEditable(false);
        ...
        spouse_surname.setEditable(false);
        ...
        spouse_firstName.setEditable(false);
        ...
        spouse_middleName.setEditable(false);
        ...
        spouse_occuReal.setEditable(false);
        ...
        spouse_contactnum.setEditable(false);
        ...
        job_startDate.setEditable(false);
        ...
        job_leaveDate.setEditable(false);
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTabbedPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 512, Short.MAX_VALUE)
                .addContainerGap())
        );
