 ...
 */
public class ViewMore_lvl2 extends javax.swing.JFrame {
    private int emp_id;
    private static dashboard_lvl2 view = null;
    
    /**
     * Creates new form ViewMore_Admin
     */
    public ViewMore_lvl2() {
        setVisible(true);
        initComponents();
    }
    
    public ViewMore_lvl2(int emp_id) {
        setVisible(true);
        initComponents();
        this.emp_id = emp_id;
    }
    
    public ViewMore_lvl2(dashboard_lvl2 newView) {
        setVisible(true);
        initComponents();
        view = newView;
    }
