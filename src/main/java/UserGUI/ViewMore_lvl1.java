 ...
 */
public class ViewMore_lvl1 extends javax.swing.JFrame {
    private int emp_id;
    private static dashboard_lvl1 view = null;
    
    /**
     * Creates new form ViewMore_Admin
     */
    public ViewMore_lvl1() {
        setVisible(true);
        initComponents();
    }
    
    public ViewMore_lvl1(int emp_id) {
        setVisible(true);
        initComponents();
        this.emp_id = emp_id;
    }
    
    public ViewMore_lvl1(dashboard_lvl1 newView) {
        setVisible(true);
        initComponents();
        view = newView;
    }
